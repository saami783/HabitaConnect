...
<head>
    ...
    <title>Informations de l'annonce</title>

    <!-- Fonts -->
    {{--    <link rel="preconnect" href="https://fonts.bunny.net">--}}
    {{--    <link href="https://fonts.bunny.net/css?family=figtree:400,600&display=swap" rel="stylesheet" />--}}
    <link href="{{ asset('css/detailOffre.css')}}" rel="stylesheet" type="text/css"/>
            ...
            @if (Route::has('login'))
                <div class="div-links">
                    @auth
                        ...
                        <a href="{{ route('logout') }}" class="deconnecter"
...
<main>
    <div class="div-main">
        ...
        <div class="div-adresse">
            <div class="div-adresse-logo">
                <img src="{{asset('images/logo_adresse.svg')}}" alt="logo adresse" class="logo_adresse">
                <p>Adresse:</p>
            </div>
...
{{--        <div class="div-"--}}
    ...
    <br>
    <h1><strong>Section équipements</strong></h1>
    ...
    @auth
        ...
        @else
            <br>
            <div>
                <h1><strong>Section Réservation</strong></h1>
                ...
                <form method="POST" action="{{ route('reservations.store') }}">
                    ...
                    @else
                        <p> Impossible de passer une réservation pour cette annonce car elle est insponible.</p>
                    @endif
                </form>
            </div>
            @endif
